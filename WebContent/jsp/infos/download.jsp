  ...
  <div class="content-wrapper">
    ...
    <section class="content container-fluid">
		...
		<c:forEach items="${noList}" var="y">
			<p><a href="${pageContext.request.contextPath}/informationz/showIn?infoId=${y.infoId}"><span style="margin-right:500px;">${y.title}</span></a> <fmt:formatDate value="${y.modifyDate }"/></p>
		</c:forEach>
        </div>
