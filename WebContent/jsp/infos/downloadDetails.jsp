...
<head>
  ...
  <title>downloadDetails.jsp</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content container-fluid">
        ...
        <div class="box-body">
        	...
        	<p>发布时间:<h3><fmt:formatDate value="${information.modifyDate}"/></p></h3>
        	<p>内容:<h3>${information.content}</h3></p>
			<p><img id="u59_img" class="img " src="${pageContext.request.contextPath}/statics/login/img/u59.png"></p>
			<p>点击下载</p>
        </div>
        <div class="box-footer ">
		<a href="${pageContext.request.contextPath}/informationz/showInfor" class="btn btn-success" >
				返回
		</a>
        </div>
	</div>
