...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <form class="form-horizontal form-label-left">
      <div class="ibox-content center" id="ss">
         <h4>当前登录用户:<span>${userCode }</span></h4>
         <h5>将要被激活的用户:<span>${totalMoney}</span></h5>
         <span>请选择需要分配区域</span>
         <input type="radio" value="1" data-label="1" name="memType" checked/>左区
         <input type="radio" value="2" data-label="1" name="memType" checked/>右区
         <button id="preservation" class="btn btnblack" type="submit">保存</button>
      </div>
      </form>
	</section>
      </div>  
