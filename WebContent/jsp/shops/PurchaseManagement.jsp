...
var path="http://localhost:8080/sl";
	$(function(){
		$("#delss").click(function(){
			...
			location.href=path+"/deleOrder?orderId="+id;
			alert("删除成功");
		})
	})
</script>
    ...
    <section class="content container-fluid">
		 ...
		 <table id="clio" class="table table-striped table-bordered table-hover dataTables-example">
                    ...
                    <c:forEach items="${list}" var="l">
                        <tr class="gradeX">
                            <td><input type="checkbox" class="min" value="${l.orderId}"></td>
                            <td>${l.orderId}</td>
                            <td>${l.userCode}</td>
                            <td>${l.receiveName}</td>     
                 ...
                 <button type="button" id="delss" class="btn btn-default btn-sm">删除</button>
    </section>
    <!-- /.content -->
  </div>
  <!-- /.content-wrapper -->
